...
export default function CommunityPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Nav */}
      <nav className="relative z-50 px-8 py-6 flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <Link href="/ai/browse" className="text-white/50 hover:text-white/80 transition text-sm">
            Browse
          </Link>
          <Link href="/ai/docs" className="text-white/50 hover:text-white/80 transition text-sm">
            Docs
          </Link>
        </div>
      </nav>
